...
export const PRICING_DATA: ModelPricing[] = [
  ...
  {
    id: 'claude-mythos-5-(limited-availability)',
    provider: 'anthropic',
  ...
  {
    id: 'claude-opus-4-(retired,-except-on-google-cloud)',
    provider: 'anthropic',
    model: 'Claude Opus 4 (retired, except on Google Cloud)',
    inputPrice: 15,
    cachedInputPrice: 1.5,
    outputPrice: 75,
    contextWindow: 200_000,
  ...
  {
    id: 'claude-haiku-3.5-(retired,-except-on-bedrock-and-google-cloud)',
    provider: 'anthropic',
    model: 'Claude Haiku 3.5 (retired, except on Bedrock and Google Cloud)',
    inputPrice: 0.8,
    cachedInputPrice: 0.08,
    outputPrice: 4,
    contextWindow: 200_000,
  ...
  {
    id: 'claude-opus-4.1-(retired,-except-on-bedrock-and-google-cloud)',
    provider: 'anthropic',
    model: 'Claude Opus 4.1 (retired, except on Bedrock and Google Cloud)',
    inputPrice: 15,
    cachedInputPrice: 1.5,
    outputPrice: 75,
    contextWindow: 200_000,
  ...
  },
  {
    ...
    longContextCachedInputPrice: 0.025,
    longContextOutputPrice: 1.5,
    contextWindow: 1_000_000,
    releaseDate: '2026-03-03',
    notes:
      'GA（Preview から名称変更）。音声入力は $0.5/M（cached $0.05/M）。Non-global リージョンは+10%（$0.275/M 等）。>200K で長文料金（標準と同額）',
  },
  {
    id: 'gemini-3.1-flash-image-nano-banana-2',
    provider: 'google',
    ...
    notes:
      'GA（Preview から名称変更）。画像出力 $60/M image tokens（解像度でトークン数変動）。Vertex 料金表参照',
  },
  {
    id: 'gemini-3.1-flash-lite-image-nano-banana-2-lite',
    provider: 'google',
    ...
    contextWindow: 1_000_000,
    notes:
      '画像出力 $30/M image tokens（入力画像 1120 tokens/枚など）。長文コンテキスト（>200K）非対応',
  },
  {
    id: 'gemini-3.5-flash',
    provider: 'google',
    ...
    outputPrice: 9,
    longContextInputPrice: 1.5,
    longContextCachedInputPrice: 0.15,
    longContextOutputPrice: 9,
    contextWindow: 1_000_000,
    notes:
  ...
  },
  {
    ...
    contextWindow: 1_000_000,
    notes:
      'text/image/video/audio 入力。Non-global リージョンは+10%（$0.33/M 等）。>200K で長文料金（標準と同額）',
  },
  {
  ...
  {
    id: 'gemini-3-pro-image-nano-banana-pro',
    provider: 'google',
